(define-public rust-etherparse-0.12
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "04d6fxw35c3zv0f4xg1nn6vg2hvb29kiwm85ac28aaafmd58rc5w"))))
    ...
    (description
     "This package provides a library for parsing & writing a bunch of packet based
protocols (@code{EthernetII}, IPv4, IPv6, UDP, TCP ...).")
...
(define-public rust-boringtun-0.6
  (package
    ...
    (arguments
     `(#:cargo-inputs (("rust-aead" ,rust-aead-0.5)
       ...
       #:cargo-development-inputs (("rust-criterion" ,rust-criterion-0.3)
                                   ("rust-etherparse" ,rust-etherparse-0.12)
                                   ("rust-tracing-subscriber" ,rust-tracing-subscriber-0.3))))
    ...
    (description
     "an implementation of the @code{WireGuard} protocol designed for
